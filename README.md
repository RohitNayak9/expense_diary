...
The Expense Tracker System is a backend API designed to help users manage and track their expenses. Users can create, and split expenses between to thier friends, and analyze their expenses through API interactions.
## Project Setup
